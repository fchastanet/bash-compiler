...
func extendModel(
	...
	for _, file := range extends {
		err := extendModelWithFile(file, referenceDir, loadedFiles, modelFilePath, resultMap)
		if err != nil {
			return err
		}
	}
...
func loadModel(
	...
	err = extendModel(model, referenceDir, loadedFiles, modelFilePath, resultMap)
	if err != nil {
		return err
	}
